...
(function dartProgram() {
  ...
  R = {
    printConsole: function($event) {
      ...
      msg = C.JSString_methods.$add("clicou em ", $.link.getAttribute("href"));
      P.print($event);
      P.print(msg);
    }
  },
  N = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(R.lib_92dconsideracao2dfinal__printConsole$closure(), {func: 1, ret: -1, args: [t2]}), false, t2);
    }
  };
  var holders = [C, H, J, P, W, R, N];
  ...
  (function installTearOffs() {
    ...
    _static_1(R, "lib_92dconsideracao2dfinal__printConsole$closure", "printConsole", 11);
  })();
